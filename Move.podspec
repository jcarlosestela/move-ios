#
#  Be sure to run `pod spec lint Move.podspec' to ensure this is a
...
"
  ...
  s.author             = { "José Estela" => "josecarloestela@gmail.com" }
  # Or just: s.author    = "José Estela"
  # s.authors            = { "José Estela" => "jose.estela@gigigo.com" }
  # s.social_media_url   = "http://twitter.com/José Estela"
  ...
  s.source_files  = "Classes", "Move/**/*.{h,m}"
  s.source_files  = "Classes", "Move/**/*.swift"
